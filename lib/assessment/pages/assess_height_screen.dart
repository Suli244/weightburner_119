...
import 'package:weightburner_119/assessment/pages/assess_desired_weight_screen.dart';
...
class AssessHeightScreen extends StatefulWidget {
  const AssessHeightScreen({
    super.key,
    required this.name,
  ...
  @override
  State<AssessHeightScreen> createState() => _AssessHeightScreenState();
}

class _AssessHeightScreenState extends State<AssessHeightScreen> {
  late WeightSliderController _controllerHeight;
              ...
              child: WbMotion(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AssessDesiredWeightScreen(
                        name: widget.name,
                        imageAvatar: widget.imageAvatar,
                        gender: widget.gender,
                        age: widget.age,
                        weight: widget.weight,
                        height: _height.toInt().toString(),
                      ),
                    ),
                  );
                },
